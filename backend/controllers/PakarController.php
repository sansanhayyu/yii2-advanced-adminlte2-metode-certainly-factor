...
class PakarController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            ->where(['Pkode_diagnosa' => Yii::$app->request->post('Pakar')['pkode_diagnosa'],'Pkode_gejala'=>Yii::$app->request->post('Pakar')['pkode_gejala']])
            ->one();
            ...
            \Yii::$app->session->setFlash('danger', 'Data yang Anda masukkan sudah ada dalam database. Silakan periksa kembali');
            }
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_pakar]);
        }
